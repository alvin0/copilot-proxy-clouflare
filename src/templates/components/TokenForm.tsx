    ...
    <React.Fragment>
      {hasToken ?
        <button
          id="token-edit"
          type="button"
          className="w-full rounded-lg border border-slate-700 bg-slate-950/40 px-4 py-2 text-sm font-semibold text-slate-100 hover:border-slate-500"
        >
          Edit Long-Term Token
        </button>
      : null}
